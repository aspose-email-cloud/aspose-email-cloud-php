...
Use [reference documentation](https://github.com/aspose-email-cloud/aspose-email-cloud-php/blob/master/doc/README.md) and [examples from this document](#usage-examples)
